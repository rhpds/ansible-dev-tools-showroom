...
You have successfully tested your custom module using pytest-ansible. Please click the **Next** button below to proceed to xref:23-tox-ansible.adoc[Lab 2.3 - Orchestrating Tests with tox-ansible].
