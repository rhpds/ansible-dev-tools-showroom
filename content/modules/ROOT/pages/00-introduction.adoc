...
+
image::00-introduction/devspaces-terminal.png[VS Code terminal interface showing basic command line operations in the Dev Spaces environment,link=self,window=blank]
